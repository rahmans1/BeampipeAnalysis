...
TFile f(Form("/global/scratch/rahmans/root/beampipeStudy/new/%s_%d_%s_%s.root",conf.Data(),nEvents,particle.Data(),energy.Data()), "RECREATE");
...
TH2D xy_rcut_p("xy_rcut_p", "(hit.x vs hit.y)*hit.p, det and 50cm<=hit.r<=190cm [MeV/e/mm^2]", 3800, -1900,1900, 3800,-1900,1900);
